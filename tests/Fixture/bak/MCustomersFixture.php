...
class MCustomersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'del_flg' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'del_flg' => 1,
            'ins_date' => '2016-08-23 05:39:03',
            'ins_person' => 1,
            'edt_date' => '2016-08-23 05:39:03',
            'edt_person' => 1
        ],
    ];
}
